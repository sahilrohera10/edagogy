...
import logo from "../../Assets/logo-edagogy.png";

const Footer = () => {
  return (
    <div
      style={{ background: "#1C144F" }}
      className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12"
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
          <p
            style={{ color: "white" }}
            className="hover:text-slat-100 text-lg font-semibold cursor-pointer leading-4 text-slate-100"
          >
            <a href="#head">Home</a>
          </p>
          <p
            style={{ color: "white" }}
            className="hover:text-gray-500 text-lg font-semibold cursor-pointer leading-4 text-gray-800"
          >
        ...
        <div className="flex items-center gap-x-8 mt-6">
          <div className="cursor-pointer">
            <a
              href="https://www.facebook.com/Edagogy.PTE.Classes/"
              target="_blank"
            >
              <svg
                style={{ color: "white" }}
          ...
          <div className="cursor-pointer">
            <a
              href="https://www.instagram.com/edagogy_pte_classes/"
              target="_blank"
            >
              <svg
                style={{ color: "white" }}
        ...
        <div className="flex items-center mt-6">
          ...
          >
            2023 <span className="font-semibold">Edagogy</span>
          </p>
